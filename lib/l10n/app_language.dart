...
class AppStrings {
  ...
  static const Map<String, List<String>> _values = {
    ...
    'cvAtsScore': ['Score ATS', 'ATS-Score', 'ATS score'],
    'cvMissingSections': [
      'Sections manquantes',
      'Fehlende Abschnitte',
      'Missing sections',
    ],
    'cvSectionPhoto': ['Photo', 'Foto', 'Photo'],
    'cvSectionContact': ['Coordonnées', 'Kontaktdaten', 'Contact details'],
    'cvSectionSummary': ['Résumé professionnel', 'Kurzprofil', 'Summary'],
    'cvSectionExperience': [
      'Expérience professionnelle',
      'Berufserfahrung',
      'Work experience',
    ],
    'cvSectionEducation': ['Formation', 'Ausbildung', 'Education'],
    'cvSectionSkills': ['Compétences', 'Kompetenzen', 'Skills'],
    'cvSectionLanguages': ['Langues', 'Sprachen', 'Languages'],
    'cvSectionSignature': [
      'Signature et date',
    ...
    'cvLevelEstimated': ['estimé', 'geschätzt', 'estimated'],
    'cvVersionsTitle': ['Mes CV', 'Meine Lebensläufe', 'My CVs'],
    'cvVersionsSubtitle': [
      'Enregistre plusieurs versions de CV par domaine ; la plus adaptée est utilisée automatiquement pour chaque candidature.',
      'Speichere mehrere Lebenslauf-Versionen nach Bereich; die passendste wird automatisch für jede Bewerbung verwendet.',
      'Save several CV versions by field; the best match is used automatically for each application.',
    ],
    'cvVersionsEmptyTitle': [
      'Aucun CV enregistré',
      'Noch kein Lebenslauf gespeichert',
      'No CV versions yet',
    ],
    'cvVersionsEmptyBody': [
      'Crée une version par domaine (ex. Informatique, Data, Business) pour que Werkly choisisse automatiquement la plus adaptée à chaque offre.',
      'Erstelle eine Version pro Bereich (z. B. Informatik, Data, Business), damit Werkly automatisch die passendste für jede Stelle auswählt.',
      'Create one version per field (e.g. Software, Data, Business) so Werkly automatically picks the best fit for each job.',
    ],
    'addCvVersion': ['Ajouter un CV', 'Lebenslauf hinzufügen', 'Add CV version'],
    'editCvVersion': ['Modifier le CV', 'Lebenslauf bearbeiten', 'Edit CV version'],
    'cvVersionLabel': ['Nom de la version', 'Name der Version', 'Version name'],
    'cvVersionLabelHint': [
      'ex. Informatique',
      'z. B. Informatik',
    ...
    'deleteCvVersionTitle': [
      'Supprimer ce CV ?',
      'Diesen Lebenslauf löschen?',
      'Delete this CV version?',
    ],
    'deleteCvVersionBody': [
    ...
    'cvVersionSaved': ['CV enregistré', 'Lebenslauf gespeichert', 'CV version saved'],
    'cvVersionDeleted': ['CV supprimé', 'Lebenslauf gelöscht', 'CV version deleted'],
    'manageCvVersions': ['Gérer mes CV', 'Lebensläufe verwalten', 'Manage CVs'],
    'cvVersionsCount': [
      '{count} version(s) enregistrée(s)',
      '{count} gespeicherte Version(en)',
      '{count} saved version(s)',
    ],
    'cvVersionsCardEmpty': [
      'Crée des versions ciblées par domaine',
      'Erstelle zielgerichtete Versionen nach Bereich',
      'Create targeted versions by field',
    ],
    'usingCvVersion': [
      'CV utilisé : {label}',
      'Verwendeter Lebenslauf: {label}',
      'Using CV: {label}',
    ],
    'usingBaseProfile': [
      'Profil de base utilisé',
      'Basisprofil wird verwendet',
      'Using your base profile',
    ],
    'autoSelectedBadge': [
    ...
    'chooseCvVersion': ['Choisir un CV', 'Lebenslauf wählen', 'Choose a CV'],
    'baseProfileOption': ['Profil de base', 'Basisprofil', 'Base profile'],
    'errorSignInManageCvVersions': [
      'Connecte-toi pour gérer tes CV.',
