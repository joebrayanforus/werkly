...
class _InterviewPrepSheetState extends State<_InterviewPrepSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      // Material (not a plain decorated Container) so the CheckboxListTile
      // below can paint its selection background and ink splashes -- those
      // only render on the nearest Material ancestor, and an opaque
      // DecoratedBox in between hides them entirely.
      child: Material(
        color: _cream,
